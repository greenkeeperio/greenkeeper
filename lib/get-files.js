...
async function discoverPackageFiles (installationId, fullName, defaultBranch) {
  const ghqueue = githubQueue(installationId)
  const relevantPackageFilePaths = await discoverPackageFilePaths(installationId, fullName, defaultBranch)
...
async function discoverPackageFilePaths (installationId, fullName, defaultBranch) {
